...
public class CustomerServiceImp implements ICustomerService {
	...
	public CustomerProductVO getCustomerAndProductById(int customerId) {
		...
		// step2 call rest api from product microservice 
		
		
		// using Product id fetch above , and url = http://localhost:8282/api/products/get/{pid}
  // accessing product microservice
	...
	public void updateProductByCustomer(Product product) {
		...
		System.out.println("updated product from customer MS " );
